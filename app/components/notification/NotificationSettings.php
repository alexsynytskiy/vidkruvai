        ...
        if (empty(self::$_settings)) {
            self::$_settings = [
                ...
                DefNotification::TYPE_ALL_NOTIFICATION => [
                    ...
                    'short-title' => 'Отримано повідомлення від організаторів',
                    'title' => 'Вам надійшло повідомлення від організаторів проекту',
                    'message' => 'Ви готові? Лише один клік відділяє вас від нової сторінки ваших пригод! Читайте, що нового очікувати від цього тижня у розділі "Новини", переходьте у кабінет "Завдання", виконуйте нові завдання, а найголовніше - отримуйте задоволення! {link_news} Дата отримання {created_at}',
                    'scenario' => [
                        'sendIfNotRead' => false,
                        'sendPeriod' => 24,
                    ],
