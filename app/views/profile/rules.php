...
?>
    ...
    <div class="steps-block rules main-rules clearfix">
        ...
        <div class="text-info-block">
            Вітаємо!
            <div class="margin-text">Восьмого вересня на Землі зберуться створіння різних світів: від Флостон Передайз
                до
                Клендату, від далекої-далекої галактики до Кібертрона. Їх усіх приведе до нас особлива
                місія – пошук і активація незнаного «шостого елементу», важливого для розвитку Всесвіту.
            </div>
        ...
        <div class="text-info-block">
            ...
            <div class="margin-text">6 запитань поділені на 3 блоки по 2 запитання. Після проходження кожного блоку ти
                отримаєш частину необхідної
                ...
                місяця після проходження всієї гри.
            </div>
            <div class="margin-text">Блоки запитань активуються раз на тиждень і доступні лише 5 днів. Коли ти відкрив
                блок, то маєш 10 хвилин на
                обидва запитання. Для зручності біля блоків працює таймер зворотного відліку. Відкрити блок можна лише
                раз.
                Тож читай швидко, використовуй Інтернет та будь уважним.
            </div>
        ...
        <div class="text-info-block text-info-block-bold">
            З правилами Гри ознайомлений. Натискаючи кнопку «Далі» я погоджуюсь з тим, що маю лише 10 хвилин на
            відповіді і,
