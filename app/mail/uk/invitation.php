...
<head>
    ...
    <style type="text/css">
        ...
        td.large-12.last.padding-main,th.large-12.last.padding-main,td.large-12.first.padding-main,th.large-12.first.padding-main{
            padding-left:55px;
            padding-right:55px;
        }
...
<body> <table class="body">
    <tr>
        <td class="center" align="center" valign="top"> <center> <table class="container text-center">
                    <tbody>
                    <tr>
                        <td> <table class="row grey">
                                <tbody>
                                <tr>
                                    <th class="small-12 large-12 columns first last"> <table>
                                            <tr>
                                                <th>   </th> <th class="expander"></th> </tr>
                                        </table>
                                    </th> </tr>
                                </tbody>
                            </table>
