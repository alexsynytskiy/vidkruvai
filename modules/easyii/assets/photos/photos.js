$(function(){
                    ...
                    success: function(response){
                        if(response.result === 'success'){
                            var html = $(photoTemplate
                                ...
                                .replace(/\{\{photo_link\}\}/g, response.photo.link))
                                .hide();
    ...
    photosBody.on('input propertychange', '.photo-description, .photo-link', function(){
        ...
        if(saveBtn.hasClass('disabled')){
            saveBtn.removeClass('disabled').on('click', function(e){
                ...
                var link = $this.siblings('.photo-link').val();
                $.post(
                    $this.attr('href'),
                    {description: text, link: link},
                    function(response){
                        if(response.result === 'success'){
