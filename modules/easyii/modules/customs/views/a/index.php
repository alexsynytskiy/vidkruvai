...
$asset = \yii\easyii\assets\AdminAsset::register($this);

$this->title = Yii::t('easyii/customs', 'Customs');
    ...
    <?php foreach($data->models as $item) : ?>
        <?php
            if($country == '' || $country != $item->country) { ?>
                <tr>
                    <td>
                        <img src="<?= $asset->baseUrl ?>/img/flags/<?= $item->country?>.png" class="position-left" alt="">
                    </td>
                </tr>
        ...
        ?>
            <tr data-id="<?= $item->primaryKey ?>">
                ...
                <td class="status">
                    <?= Html::checkbox('', $item->status == Customs::STATUS_ON, [
                        'class' => 'switch',
